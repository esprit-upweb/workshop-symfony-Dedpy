...
class FormationController extends AbstractController
{
    ...
    /**
     * @Route("/listformation/{arg}",name="listformation")
     */
    public function Listformation($arg)
    {
        $teacher = "Asma Ayari";
        $formations = array(
        ...
        return $this->render("formation/list.html.twig", array('variable' => $arg, 'teacher' => $teacher, 'formations'=>$formations));
    }
